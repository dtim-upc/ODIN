      ...
      <q-td :props="props">
        ...
        <div>
          <div class="q-gutter-xs row items-start">
            ...
            <q-input rounded filled v-model="props.row.domainLabelA" label="domainA" class="rounded-cell" dense
                     readonly/>

            <q-input filled v-model="props.row.relationship" label="Relationship"
                     :rules="[ val => !val.includes(' ')|| 'space not supported']" dense>
            ...
            <q-input rounded filled v-model="props.row.domainLabelB" label="domainB" class="rounded-cell" dense
                     readonly/>
