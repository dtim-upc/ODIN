...
if __name__ == "__main__":
    ...
    commands = [
        "flask --app .\\llm\\api_llm_interaction.py run --port 8001",
        "flask --app .\\read-write-graphdb\\api_graphdb_interaction.py run --port 8002",
        "flask --app .\\automl\\api_automl_interaction.py run --port 8003"
    ]
