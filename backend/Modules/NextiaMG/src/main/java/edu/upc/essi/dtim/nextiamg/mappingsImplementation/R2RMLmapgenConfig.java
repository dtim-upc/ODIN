 ...
 */
public class R2RMLmapgenConfig extends MappingType implements IMapgen<Graph>, MapgenODIN {

    private static final Logger LOGGER = Logger.getLogger(R2RMLmapgenConfig.class.getName());
     ...
     */
    public R2RMLmapgenConfig(Graph graphI, String configFilePath) {
        this.graphI = graphI;
        ...
        this.idColumnName = ConfigLoader.getProperty("ID_COLUMN", "expedient_number");
     ...
     */
    public R2RMLmapgenConfig withDataNamespace(String dataNamespace) {
     ...
     * @return This instance for method chaining
     */
    public R2RMLmapgenConfig withIdColumnName(String idColumnName) {
     ...
     * @return This instance for method chaining
     */
    public R2RMLmapgenConfig withTablePrefix(String tablePrefix) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        R2RMLmapgenConfig r2RMLmapgen = new R2RMLmapgenConfig(integratedGraph, configurationFilePath);
        ...
        try {
            RDFDataMgr.write((OutputStream) new FileOutputStream("/Users/anbipa/Desktop/DTIM/Cyclops/Cyclops-UC3/generated_mappings_config.ttl"), modelM, Lang.TURTLE);
